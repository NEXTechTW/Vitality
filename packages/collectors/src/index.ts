 ...
 */
export async function collect(options: CollectOptions): Promise<NormalizedRepoData> {
  ...
  const meta = await client.query<RepoMetaResult>(REPO_META_QUERY, { owner, repo });
